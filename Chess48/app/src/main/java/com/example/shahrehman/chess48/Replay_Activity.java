    ...
    private void registerClick()
    {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View viewClicked, int position, long id) {
                ...
                //String message = "You Clicked # +" + position + " which is String: " + text2.getText().toString();
                //System.out.println(message);
                //switches scenes from this class to the other class
                Intent intent = new Intent(viewClicked.getContext(), Chess_Activity.class).putExtra(playGame, message);
